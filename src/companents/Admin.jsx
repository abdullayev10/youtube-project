...
import imgdownl from "../img/download.png"
import img4 from"../img/delete.jpg"
...
export default function Admin() {
    ...
    useEffect(() => {
        axios.get(`${API}/api/files`).then(res => {
        ...
        <div class="container">
            <header class="header">
                <section class="header-left">
                    <Link to="/index" title="YouTube Home">
                        <svg viewbox="0 0 200 60" focusable="false" style={{"pointer-events": "none", "display": "block", "width": "200px", "height": "60px"}}><g viewbox="0 0 200 60" class="style-scope yt-icon"><g>
            ...
            <main class="main">
                <div class="wrapper">
                    ...
                    <form id="videoForm" action="#" class="site-form">
                        ...
                        <input onClick={clickAdmin} type="submit" value="Upload" id="submitButton" />
                    </form>
                    ...
                    <ul id="videosList" class="videos-list">
                        {
                            files.map(file => {
                                ...
                                let month = new Date(file.date).getMonth();
                                let day = new Date(file.date).getDate();
                                let months = month + 1;
                                return <li class="iframe">
                                     <div className="delete">
                                        <img onClick={() => clickDelete(file.id)} src={img4} alt="error"/>
                                    </div>
                                    <object data={`${API}/` + file.file} width="270px" height="200px"></object>
